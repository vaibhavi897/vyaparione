...
const getAnalytics = async (req, res) => {
   try {
      ...
      const currentMonthData = monthlyRevenue.find(m => m._id.month === currentMonth && m._id.year === currentYear) || { revenue: 0 };
      const previousMonthData = monthlyRevenue.find(m => m._id.month === previousMonth && m._id.year === previousMonthYear) || { revenue: 0 };
      ...
      if (previousMonthRevenue > 0) {
          ...
          revenueGrowth = 100; // infinite growth if prev was 0 and now we have revenue
      }
